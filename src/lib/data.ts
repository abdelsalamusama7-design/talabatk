...
export const stores: Store[] = [
  ...
  // ===== كشك =====
  {
    ...
    deliveryFee: 10,
    products: [
      { id: "k1", name: "شيبسي كبير", price: 20, description: "شيبسي ليز كبير - نكهات متعددة", image: prodChips },
      { id: "k2", name: "سجائر كليوباترا", price: 55, description: "علبة كليوباترا سوبر", image: prodCigarettes },
      { id: "k3", name: "سجائر إل إم", price: 75, description: "علبة إل إم بلو", image: prodCigarettes },
      { id: "k4", name: "كولا 330 مل", price: 12, description: "كوكاكولا علبة 330 مل", image: prodCola },
      { id: "k5", name: "مياه معدنية", price: 5, description: "زجاجة مياه معدنية 600 مل", image: prodWaterDrinks },
      { id: "k6", name: "شوكولاتة", price: 15, description: "شوكولاتة متنوعة - كادبوري / جالاكسي", image: prodCandy },
      { id: "k7", name: "بسكويت", price: 10, description: "بسكويت أبو عوف / لواكر", image: prodBiscuits },
      { id: "k8", name: "لبان", price: 5, description: "لبان كلورتس / ترايدنت", image: prodGum },
    ],
  },
  {
    id: "haga-kiosk",
    ...
    deliveryFee: 10,
    products: [
      { id: "k9", name: "شيبسي صغير", price: 10, description: "شيبسي ليز صغير - جبنة / بصل", image: prodChips },
      { id: "k10", name: "سجائر مارلبورو", price: 85, description: "علبة مارلبورو ريد", image: prodCigarettes },
      { id: "k11", name: "سجائر ميريت", price: 80, description: "علبة ميريت سيلفر", image: prodCigarettes },
      { id: "k12", name: "عصير تتراباك", price: 8, description: "عصير فرواتي / جهينة صغير", image: prodWaterDrinks },
      { id: "k13", name: "شوكولاتة سنيكرز", price: 20, description: "سنيكرز / تويكس / كيت كات", image: prodCandy },
      { id: "k14", name: "بسكويت أوريو", price: 15, description: "أوريو عادي أو بالشوكولاتة", image: prodBiscuits },
      { id: "k15", name: "كولا لتر", price: 22, description: "كوكاكولا أو بيبسي لتر", image: prodCola },
      { id: "k16", name: "لبان نعناع", price: 5, description: "لبان نعناع منعش", image: prodGum },
    ],
  },
  {
    id: "karam-kiosk",
    ...
    deliveryFee: 8,
    products: [
      { id: "k17", name: "شيبسي دوريتوس", price: 18, description: "دوريتوس جبنة ناتشو كبير", image: prodChips },
      { id: "k18", name: "سجائر ونستون", price: 70, description: "علبة ونستون بلو", image: prodCigarettes },
      { id: "k19", name: "سجائر كليوباترا بلاك", price: 60, description: "علبة كليوباترا بلاك ليبل", image: prodCigarettes },
      { id: "k20", name: "ريد بول", price: 35, description: "ريد بول مشروب طاقة 250 مل", image: prodWaterDrinks },
      { id: "k21", name: "شوكولاتة فليك", price: 12, description: "كادبوري فليك / ديري ميلك", image: prodCandy },
