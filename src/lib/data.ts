...
export const stores: Store[] = [
  ...
  },
  {
    ...
    deliveryFee: 10,
    products: [
      { id: "p52", name: "كيلو طماطم بلدي", price: 18, description: "طماطم بلدي طازة من المزرعة", image: storeVegetables2 },
      { id: "p53", name: "كيلو فلفل رومي", price: 25, description: "فلفل رومي ألوان مشكلة", image: storeVegetables2 },
      { id: "p54", name: "كيلو باذنجان", price: 12, description: "باذنجان رومي طازج", image: storeVegetables2 },
      { id: "p55", name: "كيلو كوسة", price: 14, description: "كوسة صغيرة طازة", image: storeVegetables2 },
      { id: "p56", name: "حزمة بقدونس + شبت", price: 5, description: "خضرة طازة مغسولة", image: storeVegetables2 },
      { id: "p57", name: "كيلو جزر", price: 10, description: "جزر طازج ومقرمش", image: storeVegetables2 },
    ],
  },
  {
    id: "khedar-eltazeg",
  ...
  },
  {
    ...
    deliveryFee: 12,
    products: [
      { id: "p58", name: "كيلو مانجو", price: 60, description: "مانجو عويسي طازة", image: storeFruits1 },
      { id: "p59", name: "كيلو فراولة", price: 45, description: "فراولة طازة ومختارة", image: storeFruits1 },
      { id: "p60", name: "كيلو برتقال", price: 15, description: "برتقال بلدي حلو", image: storeFruits1 },
      { id: "p61", name: "كيلو موز", price: 20, description: "موز مستوي وطازج", image: storeFruits1 },
      { id: "p62", name: "كيلو عنب", price: 40, description: "عنب أحمر بدون بذر", image: storeFruits1 },
    ],
  },
  {
    id: "fruits-plaza",
    ...
    deliveryFee: 10,
    products: [
      { id: "p63", name: "كيلو تفاح أحمر", price: 35, description: "تفاح أحمر مستورد", image: storeFruits2 },
      { id: "p64", name: "كيلو كيوي", price: 55, description: "كيوي طازج ومستورد", image: storeFruits2 },
      { id: "p65", name: "كيلو أناناس", price: 70, description: "أناناس طازج مقشر", image: storeFruits2 },
      { id: "p66", name: "سلة فواكه مشكلة", price: 120, description: "تشكيلة فواكه موسمية 2 كيلو", image: storeFruits2 },
      { id: "p67", name: "كيلو بطيخ مقطع", price: 25, description: "بطيخ أحمر مقطع جاهز", image: storeFruits2 },
    ],
  },
];
